...
CPPFLAGS+=-DMODES_DUMP1090_VERSION=\"$(DUMP1090_VERSION)\" -DENABLE_WEBSERVER -DALLOW_AGGRESSIVE
#CFLAGS+=-O2 -g -Wall -Werror -W
CFLAGS+=-O2 -g -Wall -W 
LIBS=-lpthread -lm `pkg-config --libs gsl`
VIEWLIBS=-lpthread -lm
...
dump1090.o: CFLAGS += `pkg-config --cflags librtlsdr gsl`

dump1090: dump1090.o anet.o interactive.o mode_ac.o mode_s.o net_io.o crc.o demod_2400.o stats.o cpr.o icao_filter.o track.o util.o convert.o AER.o $(COMPAT)
	$(CC) -g -o $@ $^ $(LIBS) $(LIBS_RTL) $(LDFLAGS) 

view1090: view1090.o anet.o interactive.o mode_ac.o mode_s.o net_io.o convert.o  crc.o stats.o cpr.o icao_filter.o track.o util.o AER.o $(COMPAT)
	$(CC) -g -o $@ $^ $(LIBS) $(LDFLAGS)

faup1090: faup1090.o interactive.o anet.o mode_ac.o mode_s.o net_io.o crc.o convert.o stats.o cpr.o icao_filter.o track.o util.o AER.o $(COMPAT)
	$(CC) -g -o $@ $^ $(LIBS) $(LDFLAGS)
